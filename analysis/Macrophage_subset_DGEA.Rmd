...
raincloud.plots(
  gene_list     = genes,
  plot_title    = "Macrophages CMFHM_TGF vs. CMFHM_NC: Gene distribution profiles across MT conditions",
  plot_subtitle = "Geneset = Cell Adhesion",
  seurat_obj = Macrophages,
  colors = gradient_colors2
)
...
raincloud.plots(
  gene_list     = genes,
  plot_title    = "Macrophages CMFHM_TGF vs. CMFHM_NC: Gene distribution profiles across MT conditions",
  plot_subtitle = "Geneset = regulation of inflammatory response",
  seurat_obj = Macrophages,
  colors = gradient_colors2
)
...
## DecoupleR - Transcription factor activity inference from scRNA-seq
