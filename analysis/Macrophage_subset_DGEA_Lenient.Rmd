...
ranked_vector <- Macrophages.MAST$avg_log2FC

names(ranked_vector) <- Macrophages.MAST$gene
...
p_apear <- p_apear + labs(
  ...
  subtitle = "MT-Macrophages: differences in CMFHM_TGF compared to CMFHM_NC",
  color    = "NES",       
) +
theme(
  plot.title.position = "plot",
