---
title: "Cardiomyocytes Baseline_Mac_Response Lenient Thresholds"
author: "Sophie.Alice"
date: "2026-07-02"
...
# DEGs of Baseline Macrophage response
 ...
 - CMFHM_NC vs CMF_NC = Effect of Macrophage Presence on MT Cardiomyocytes without TGF-Beta
...
## Functional gene set enrichment Analysis - with Limma
...
p_apear <- p_apear + labs(
  ...
  subtitle = "MT-Cardiomyocytes: differences in CMFHM_NC compared to CMF_NC",
  color    = "NES",       
) +
theme(
  plot.title.position = "plot",
...
ggplot(go_plot_data, aes(x = GeneRatio_num, y = Description)) + 
  ...
  theme_bw() + 
  labs(
    title = "DEG MT-Cardiomyocytes CMFHM_NC vs CMF_NC: GO BP Enrichment", 
...
p_apear <- p_apear + labs(
  title    = "DEG MT-Cardiomyocytes CMFHM_NC vs CMF_NC: GO Biological Process Enrichment",
...
p_combined <- p_combined + labs(
  title    = "DEG MT-Cardiomyocytes CMFHM_NC vs CMF_NC: Combined GO BP Enrichment",
...
# Upregulated in Cardiomyocytes upon Macrophage addition (No TGF-B stimulation)
...
descr <- "negative regulation of myoblast fusion"
...
if (total_genes > 0) {
  for (i in seq(1, total_genes, by = chunk_size)) {
    ...
    print(SCpubr::do_DotPlot(
      ...
      dot.scale = 10,
      plot.title = "negative regulation of myoblast fusion: Gene Set Expression Across Conditions",
...
for (i in seq(1, total_genes, by = chunk_size)) {
  ...
  print(raincloud.plots(
    ...
    plot_title    = "Cardiomyocytes CMFHM_NC vs CMF_NC: Gene distribution profiles across MT conditions",
    plot_subtitle = paste0("Geneset = negative regulation of myoblast fusion - Slice ", slice_num),
...
descr <- "proton motive force-driven ATP synthesis"
...
if (total_genes > 0) {
  for (i in seq(1, total_genes, by = chunk_size)) {
    ...
    print(SCpubr::do_DotPlot(
      ...
      features = genes[i:end_idx],
      dot.scale = 10,
      plot.title = "proton motive force-driven ATP synthesis: Gene Set Expression Across Conditions",
      plot.subtitle = paste0("Slice ", slice_num, " (Genes ", i, " to ", end_idx, " of ", total_genes, ")")
    ))
  }
}
...
for (i in seq(1, total_genes, by = chunk_size)) {
  ...
  print(raincloud.plots(
    gene_list     = genes[i:end_idx],
    plot_title    = "Cardiomyocytes CMFHM_NC vs CMF_NC: Gene distribution profiles across MT conditions",
    plot_subtitle = paste0("Geneset = proton motive force-driven ATP synthesis - Slice ", slice_num),
    seurat_obj    = Cardiomyocytes,
    colors        = gradient_colors4
  ))
}
...
# Downregulated in Cardiomyocytes upon Macrophage addition (No TGF-B stimulation)
...
descr <- "actin cytoskeleton organization"
...
if (total_genes > 0) {
  for (i in seq(1, total_genes, by = chunk_size)) {
    ...
    print(SCpubr::do_DotPlot(
      ...
      features = genes[i:end_idx],
      dot.scale = 10,
      plot.title = "actin cytoskeleton organization: Gene Set Expression Across Conditions",
      plot.subtitle = paste0("Slice ", slice_num, " (Genes ", i, " to ", end_idx, " of ", total_genes, ")")
    ))
  }
}
...
for (i in seq(1, total_genes, by = chunk_size)) {
  ...
  print(raincloud.plots(
    gene_list     = genes[i:end_idx],
    plot_title    = "Cardiomyocytes CMFHM_NC vs CMF_NC: Gene distribution profiles across MT conditions",
    plot_subtitle = paste0("Geneset = actin cytoskeleton organization - Slice ", slice_num),
    seurat_obj    = Cardiomyocytes,
    colors        = gradient_colors4
  ))
}
...
if (total_genes > 0) {
  for (i in seq(1, total_genes, by = chunk_size)) {
    ...
    print(SCpubr::do_DotPlot(
      ...
      features = genes[i:end_idx],
      dot.scale = 10,
      plot.title = "immune system process: Gene Set Expression Across Conditions",
      plot.subtitle = paste0("Slice ", slice_num, " (Genes ", i, " to ", end_idx, " of ", total_genes, ")")
    ))
  }
}
...
for (i in seq(1, total_genes, by = chunk_size)) {
  ...
  print(raincloud.plots(
    gene_list     = genes[i:end_idx],
    plot_title    = "Cardiomyocytes CMFHM_NC vs CMF_NC: Gene distribution profiles across MT conditions",
    plot_subtitle = paste0("Geneset = immune system process - Slice ", slice_num),
    seurat_obj    = Cardiomyocytes,
    colors        = gradient_colors4
  ))
}
