...
descr <- "regulation of cell-cell adhesion"
...
if (total_genes > 0) {
  for (i in seq(1, total_genes, by = chunk_size)) {
    ...
    print(SCpubr::do_DotPlot(
      ...
      features = genes[i:end_idx],
      dot.scale = 10,
      plot.title = "regulation of cell-cell adhesion: Gene Set Expression Across Conditions",
      plot.subtitle = paste0("Slice ", slice_num, " (Genes ", i, " to ", end_idx, " of ", total_genes, ")")
    ))
  }
}
...
for (i in seq(1, total_genes, by = chunk_size)) {
  ...
  print(raincloud.plots(
    gene_list     = genes[i:end_idx],
    plot_title    = "Fibroblasts CMFHM_NC vs CMF_NC: Gene distribution profiles across MT conditions",
    plot_subtitle = paste0("Geneset = regulation of cell-cell adhesion - Slice ", slice_num),
    seurat_obj    = Fibroblasts,
    colors        = gradient_colors4
  ))
}
...
if (total_genes > 0) {
  for (i in seq(1, total_genes, by = chunk_size)) {
    ...
    print(SCpubr::do_DotPlot(
      ...
      features = genes[i:end_idx],
      dot.scale = 10,
      plot.title = "cell migration: Gene Set Expression Across Conditions",
      plot.subtitle = paste0("Slice ", slice_num, " (Genes ", i, " to ", end_idx, " of ", total_genes, ")")
    ))
  }
}
...
for (i in seq(1, total_genes, by = chunk_size)) {
  ...
  print(raincloud.plots(
    gene_list     = genes[i:end_idx],
    plot_title    = "Fibroblasts CMFHM_NC vs CMF_NC: Gene distribution profiles across MT conditions",
    plot_subtitle = paste0("Geneset = cell migration - Slice ", slice_num),
    seurat_obj    = Fibroblasts,
    colors        = gradient_colors4
  ))
}
