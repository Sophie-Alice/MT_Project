...
descr <- "striated muscle cell differentiation"
...
if (total_genes > 0) {
  for (i in seq(1, total_genes, by = chunk_size)) {
    ...
    print(SCpubr::do_DotPlot(
      ...
      dot.scale = 10,
      plot.title = "striated muscle cell differentiation: Gene Set Expression Across Conditions",
...
for (i in seq(1, total_genes, by = chunk_size)) {
  ...
  print(raincloud.plots(
    ...
    plot_subtitle = paste0("Geneset = striated muscle cell differentiation - Slice ", slice_num),
...
if (total_genes > 0) {
  for (i in seq(1, total_genes, by = chunk_size)) {
    ...
    print(SCpubr::do_DotPlot(
      ...
      features = genes[i:end_idx],
      dot.scale = 10,
      plot.title = "cell-cell fusion: Gene Set Expression Across Conditions",
      plot.subtitle = paste0("Slice ", slice_num, " (Genes ", i, " to ", end_idx, " of ", total_genes, ")")
    ))
  }
}
...
for (i in seq(1, total_genes, by = chunk_size)) {
  ...
  print(raincloud.plots(
    gene_list     = genes[i:end_idx],
    plot_title    = "Cardiomyocytes CMF_TGF vs. CMF_NC: Gene distribution profiles across MT conditions",
    plot_subtitle = paste0("Geneset = cell-cell fusion - Slice ", slice_num),
    seurat_obj    = Cardiomyocytes,
    colors        = gradient_colors4
  ))
}
...
## Not enought Pathways - no sign. ones
