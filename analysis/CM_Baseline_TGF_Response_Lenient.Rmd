...
# DEGs of Fibrotic response to TGF-B without Macrophages
 ...
 - CMF_TGF vs CMF_NC = Effect of TGF-Beta on MT Cardiomyocytes without Macrophages
...
p_apear <- p_apear + labs(
  ...
  subtitle = "MT-Cardiomyocytes: differences in CMF_TGF compared to CMF_NC",
  color    = "NES",       
) +
theme(
  plot.title.position = "plot",
...
ggplot(go_plot_data, aes(x = GeneRatio_num, y = Description)) + 
  ...
  theme_bw() + 
  labs(
    title = "DEG MT-Cardiomyocytes CMF_TGF vs CMF_NC: GO BP Enrichment", 
...
p_combined <- p_combined + labs(
  title    = "DEG MT-Cardiomyocytes CMF_TGF vs CMF_NC: Combined GO BP Enrichment",
...
# Upregulated in Cardiomyocytes upon TGF-Beta stimulation (No Macrophages)
...
for (i in seq(1, total_genes, by = chunk_size)) {
  ...
  print(raincloud.plots(
    ...
    plot_title    = "Cardiomyocytes CMF_TGF vs. CMF_NC: Gene distribution profiles across MT conditions",
...
if (total_genes > 0) {
  for (i in seq(1, total_genes, by = chunk_size)) {
    ...
    print(SCpubr::do_DotPlot(
      ...
      features = genes[i:end_idx],
      dot.scale = 10,
      plot.title = "myotube differentiation: Gene Set Expression Across Conditions",
      plot.subtitle = paste0("Slice ", slice_num, " (Genes ", i, " to ", end_idx, " of ", total_genes, ")")
    ))
  }
}
...
for (i in seq(1, total_genes, by = chunk_size)) {
  ...
  print(raincloud.plots(
    gene_list     = genes[i:end_idx],
    plot_title    = "Cardiomyocytes CMF_TGF vs. CMF_NC: Gene distribution profiles across MT conditions",
    plot_subtitle = paste0("Geneset = myotube differentiation - Slice ", slice_num),
    seurat_obj    = Cardiomyocytes,
    colors        = gradient_colors4
  ))
}
...
# Downregulated in Cardiomyocytes upon TGF-Beta stimulation (No Macrophages)
...
descr <- "actin filament-based movement"
...
if (total_genes > 0) {
  for (i in seq(1, total_genes, by = chunk_size)) {
    ...
    print(SCpubr::do_DotPlot(
      ...
      features = genes[i:end_idx],
      dot.scale = 10,
      plot.title = "actin filament-based movement: Gene Set Expression Across Conditions",
      plot.subtitle = paste0("Slice ", slice_num, " (Genes ", i, " to ", end_idx, " of ", total_genes, ")")
    ))
  }
}
...
for (i in seq(1, total_genes, by = chunk_size)) {
  ...
  print(raincloud.plots(
    gene_list     = genes[i:end_idx],
    plot_title    = "Cardiomyocytes CMF_TGF vs. CMF_NC: Gene distribution profiles across MT conditions",
    plot_subtitle = paste0("Geneset = actin filament-based movement - Slice ", slice_num),
    seurat_obj    = Cardiomyocytes,
    colors        = gradient_colors4
  ))
}
