...
p_apear <- p_apear + labs(
  ...
  subtitle = "MT-Fibroblasts: differences in CMFHM_TGF compared to CMFHM_NC",
  color    = "NES",       
) +
theme(
  plot.title.position = "plot",
...
ggplot(go_plot_data, aes(x = GeneRatio_num, y = Description)) + 
  ...
  theme_bw() + 
  labs(
    title = "DEG MT-Fibroblasts CMFHM_TGF vs CMFHM_NC: GO BP Enrichment", 
...
p_combined <- p_combined + labs(
  title    = "DEG MT-Fibroblasts CMFHM_TGF vs CMFHM_NC: Combined GO BP Enrichment",
