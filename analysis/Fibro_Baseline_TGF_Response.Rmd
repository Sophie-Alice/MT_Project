...
ggplot(go_plot_data, aes(x = GeneRatio_num, y = Description)) + 
  ...
  theme_bw() + 
  labs(
    title = "DEG Fibroblasts CMF_TGF vs CMF_NC: GO BP Enrichment", 
...
emapplot(
  ...
  theme_bw() + 
  labs(
    title    = "DEG MT-Fibroblasts CMF_TGF vs CMF_NC: GO BP Enrichment", 
...
p_combined <- p_combined + labs(
  title    = "DEG MT-Fibroblasts CMF_TGF vs CMF_NC: Combined GO BP Enrichment",
...
if (total_genes > 0) {
  for (i in seq(1, total_genes, by = chunk_size)) {
    ...
    print(SCpubr::do_DotPlot(
      ...
      dot.scale = 10,
      plot.title = "ECM organization: Gene Set Expression Across Conditions",
