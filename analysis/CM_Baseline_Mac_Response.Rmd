...
############################ All signif. Pathways - Not enough Pathways
...
descr <- "negative regulation of developmental process"
...
if (total_genes > 0) {
  for (i in seq(1, total_genes, by = chunk_size)) {
    ...
    print(SCpubr::do_DotPlot(
      ...
      features = genes[i:end_idx],
      dot.scale = 10,
      plot.title = "negative regulation of developmental process: Gene Set Expression Across Conditions",
      plot.subtitle = paste0("Slice ", slice_num, " (Genes ", i, " to ", end_idx, " of ", total_genes, ")")
    ))
  }
}
...
for (i in seq(1, total_genes, by = chunk_size)) {
  ...
  print(raincloud.plots(
    gene_list     = genes[i:end_idx],
    plot_title    = "Cardiomyocytes CMFHM_NC vs CMF_NC: Gene distribution profiles across MT conditions",
    plot_subtitle = paste0("Geneset = negative regulation of developmental process - Slice ", slice_num),
    seurat_obj    = Cardiomyocytes,
    colors        = gradient_colors4
  ))
}
...
for (i in seq(1, total_genes, by = chunk_size)) {
  ...
  print(raincloud.plots(
    gene_list     = genes[i:end_idx],
    plot_title    = "Cardiomyocytes CMFHM_NC vs CMF_NC: Gene distribution profiles across MT conditions",
    plot_subtitle = paste0("Geneset = ECM organization - Slice ", slice_num),
    seurat_obj    = Cardiomyocytes,
    colors        = gradient_colors4
  ))
}
...
descr <- "actin filament organization"
...
if (total_genes > 0) {
  for (i in seq(1, total_genes, by = chunk_size)) {
    ...
    print(SCpubr::do_DotPlot(
      ...
      features = genes[i:end_idx],
      dot.scale = 10,
      plot.title = "actin filament organization: Gene Set Expression Across Conditions",
      plot.subtitle = paste0("Slice ", slice_num, " (Genes ", i, " to ", end_idx, " of ", total_genes, ")")
    ))
  }
}
...
for (i in seq(1, total_genes, by = chunk_size)) {
  ...
  print(raincloud.plots(
    gene_list     = genes[i:end_idx],
    plot_title    = "Cardiomyocytes CMFHM_NC vs CMF_NC: Gene distribution profiles across MT conditions",
    plot_subtitle = paste0("Geneset = actin filament organization - Slice ", slice_num),
    seurat_obj    = Cardiomyocytes,
    colors        = gradient_colors4
  ))
}
