...
#Data@meta.data <- Data@meta.data %>% select(-contains("scDblFinder"))
...
dplyr::filter(Markers_top10, cluster == "0")
...
dplyr::filter(Markers_top10, cluster == "1")
...
dplyr::filter(Markers_top10, cluster == "2")
...
dplyr::filter(Markers_top10, cluster == "3")
# Checking Cluster 4 -> TNNC1 high = beating subunit?
...
dplyr::filter(Markers_top10, cluster == "4")
...
dplyr::filter(Markers_top10, cluster == "5")
...
dplyr::filter(Markers_top10, cluster == "6")
...
dplyr::filter(Markers_top10, cluster == "7")
