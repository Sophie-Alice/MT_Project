...
Degs <- DEG.lists$Baseline_TGF_Response
...
ggplot(go_plot_data, aes(x = GeneRatio_num, y = Description)) + 
  ...
  theme_bw() + 
  labs(
    title = "DEG Fibroblasts CMF_TGF vs CMF_NC: GO Biological Process Enrichment", 
...
# Upregulated in Fibroblasts upon TGF-Beta stimulation (No Macrophages)
...
SCpubr::do_DotPlot(Fibroblasts, 
                   features = genes[1:16],
                   dot.scale = 10,
                   plot.title = "ECM Gene Set Expression Across Conditions - Slice 1") 
SCpubr::do_DotPlot(Fibroblasts, 
                   features = genes[17:32],
                   dot.scale = 10,
                   plot.title = "ECM Gene Set Expression Across Conditions - Slice 2") 
...
for (i in seq(1, total_genes, by = chunk_size)) {
  ...
  print(raincloud.plots(
    ...
    plot_title    = "Fibroblasts CMF_TGF vs. CMF_NC: Gene distribution profiles across MT conditions",
...
The geneset is quite big so for visualization purposes it will be split in sets of 16
...
SCpubr::do_DotPlot(Fibroblasts, 
                   features = genes[1:30],
                   dot.scale = 10,
                   plot.title = "Cell Adhesion Gene Set Expression Across Conditions - Slice 1") 
SCpubr::do_DotPlot(Fibroblasts, 
                   features = genes[31:60],
                   dot.scale = 10,
                   plot.title = "Cell Adhesion Gene Set Expression Across Conditions - Slice 2") 
...
# Downregulated in Fibroblasts upon TGF-Beta stimulation (No Macrophages)
...
descr <- "cAMP/PKA signal transduction"
...
SCpubr::do_DotPlot(Fibroblasts, 
                   features = genes,
                   dot.scale = 10,
                   plot.title = "cAMP/PKA signal transduction: Gene Set Expression Across Conditions") 
...
for (i in seq(1, total_genes, by = chunk_size)) {
  ...
  print(raincloud.plots(
    gene_list     = genes[i:end_idx],
    plot_title    = "Fibroblasts CMF_TGF vs. CMF_NC: Gene distribution profiles across MT conditions",
    plot_subtitle = paste0("Geneset = cAMP/PKA signal transduction - Slice ", slice_num),
    seurat_obj    = Fibroblasts,
    colors        = gradient_colors4
  ))
}
...
descr <- "actomyosin structure organization"
...
SCpubr::do_DotPlot(Fibroblasts, 
                   features = genes,
                   dot.scale = 10,
                   plot.title = "actomyosin structure organization: Gene Set Expression Across Conditions") 
...
for (i in seq(1, total_genes, by = chunk_size)) {
  ...
  print(raincloud.plots(
    gene_list     = genes[i:end_idx],
    plot_title    = "Fibroblasts CMF_TGF vs. CMF_NC: Gene distribution profiles across MT conditions",
    plot_subtitle = paste0("Geneset = actomyosin structure organization - Slice ", slice_num),
    seurat_obj    = Fibroblasts,
    colors        = gradient_colors4
  ))
}
